    ...
    _this.renderProvider = function (value) {
      ...
      return /*#__PURE__*/React.createElement(ConfigConsumer, null, function (_ref) {
        ...
        return /*#__PURE__*/React.createElement(DrawerContext.Provider, {
          ...
          handler: false
        }, omit(rest, ['zIndex', 'style', 'closable', 'destroyOnClose', 'drawerStyle', 'headerStyle', 'bodyStyle', 'footerStyle', 'footer', 'locale', 'title', 'push', 'visible', 'getPopupContainer', 'rootPrefixCls', 'getPrefixCls', 'renderEmpty', 'csp', 'pageHeader', 'autoInsertSpaceInButton', 'width', 'height', 'dropdownMatchSelectWidth']), {
          getContainer: // 有可能为 false，所以不能直接判断
          rest.getContainer === undefined ? function () {
            return getPopupContainer ? getPopupContainer(document.body) : undefined;
          } : rest.getContainer
        }, offsetStyle, {
          prefixCls: prefixCls,
          open: visible,
